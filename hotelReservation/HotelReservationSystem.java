...
public class HotelReservationSystem {
    public ArrayList<HotelReservation> hotelList = new ArrayList<>();
    ...
    public String  compareAndGetCheapPrice(int[] rate, ArrayList<HotelReservation> hotelList){
    ...
    public void findBestRatedHotel(){
        ...
        Iterator<HotelReservation> iterator = hotelList.iterator();
        while (iterator.hasNext()){
            HotelReservation h1 = iterator.next();
    ...
    public static void main(String[] args) {
        ...
        reservationSystem.hotelList.add(
                new HotelReservation("Lakewood","3",1000,1500,2000,1200));
        reservationSystem.hotelList.add(
                new HotelReservation("Bridgewood","4",1500,2500,1000,1300));
        reservationSystem.hotelList.add(
                new HotelReservation("Ridgewood","5",2000,3000,1700,1500));
